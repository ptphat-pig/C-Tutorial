...
int main () {
    ...
    cout << "===================Example 4=====================\n";
    // Example 5: This example is Check Primitive Value Limits
    string example5 = "This example is Check Primitive Value Limits" "\n"; // This example is Check Primitive Value Limits 
    ...
    cout << "GPA is :" << herGPA << "\n"; // print GPA is 4.69
    cout << "Salary drawn up to :" << herSalaryDrawnUpto << "\n"; // print Salary drawn up to : 12047235
